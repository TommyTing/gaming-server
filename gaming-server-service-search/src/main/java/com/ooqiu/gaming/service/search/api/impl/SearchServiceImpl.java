    ...
    public List<SearchResult> search(String query, int page, int row) {
        ...
        try {
            ...
            for (SolrDocument document : solrDocumentList) {
                ...
                searchResult.setGetArticle_url((String) document.get("article_url"));
                searchResult.setGetArticle_source((String) document.get("article_source"));
                searchResult.setGetArticle_introduction((String) document.get(
                        "article_introduction"));
                searchResult.setGetArticle_cover((String) document.get("article_cover"));
