...
public class Article implements Serializable {
    ...
    public String toString() {
        return "Article{" +
                ...
                ", tag='" + tag + '\'' +
                ", cover='" + cover + '\'' +
                ", coverShowType='" + coverShowType + '\'' +
                ", shareType='" + shareType + '\'' +
                ", canComment='" + canComment + '\'' +
                ", contentType='" + contentType + '\'' +
                ", unlikeEnable='" + unlikeEnable + '\'' +
                ...
                ", fontBold='" + fontBold + '\'' +
                ", shareUrl='" + shareUrl + '\'' +
                ", likeNumShow='" + likeNumShow + '\'' +
                ", unlikeNumShow='" + unlikeNumShow + '\'' +
                ", inative='" + inative + '\'' +
                ", skipAd='" + skipAd + '\'' +
                ", isH5='" + isH5 + '\'' +
                ", authorId=" + authorId +
